...
nnoremap <silent>[unite]gb  :<C-u>Unite -buffer-name=giti                                  giti/branch<cr>
nnoremap <silent>[unite]gl  :<C-u>Unite -buffer-name=giti                                  giti/log<cr>
nnoremap <silent>[unite]gr  :<C-u>Unite -buffer-name=giti                                  giti/remote<cr>
nnoremap <silent>[unite]gs  :<C-u>Unite -buffer-name=giti                                  giti/status<cr>
nnoremap <silent>[unite]gg  :<C-u>Unite -buffer-name=giti                                  giti/grep<cr>
